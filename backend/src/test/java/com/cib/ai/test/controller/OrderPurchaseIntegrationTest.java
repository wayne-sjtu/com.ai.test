...
import com.cib.ai.test.service.ExternalTaConfirmService;
import com.cib.ai.test.taclient.ExternalTaClient;
import com.cib.ai.test.taclient.FaultMode;
import com.cib.ai.test.taclient.TaCallback;
...
class OrderPurchaseIntegrationTest {
        ...
        private com.cib.ai.test.repository.entity.Order orderByRequest(String clientRequestId) {
